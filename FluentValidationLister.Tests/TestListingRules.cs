...
{
    [Fact(DisplayName = "Null validator does not throw ArgumentNullException")]
    public void NullValidator_DoesNotThrowArgumentNullException() =>
        new ValidationLister(validator: null, typeof(Person), new ServiceCollection()
            .BuildServiceProvider()).Should().NotBeNull();
    ...
    public void ExclusiveBetween_ReturnsCorrectValues()
    {
        ...
        anotherIntRules["exclusiveRange"].Should().BeOfType<FromToValues>();
